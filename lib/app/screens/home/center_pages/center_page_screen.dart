  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx((){
        ...
        final centerData = controller.profileDataModel.value?.data.center;
        if (centerData == null) {
          return const Center(child: Text("No center data available"));
        }
        return SafeArea(
          child: Column(
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            centerData.description ?? "No Name",
                          ...
                          Column(children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text( centerData.localArea ?? "No Address",style: AppTextStyles.linkText,)
                              ],),
                            SizedBox(height: 10,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
